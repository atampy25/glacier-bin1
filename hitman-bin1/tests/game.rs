					...
					($data:expr, $round:literal, $h1_ty:ty, $h2_ty:ty, $h3_ty:ty) => {
						match game.version {
							...
							hitman_commons::game::GameVersion::H1 => {
								...
								hitman_bin1::serialize(&hitman_bin1::deserialize::<$h1_ty>(&$data).unwrap_or_else(
									|e| {
										panic!(
							...
							hitman_commons::game::GameVersion::H2 => {
								...
								hitman_bin1::serialize(&hitman_bin1::deserialize::<$h2_ty>(&$data).unwrap_or_else(
									|e| {
										panic!(
											"Couldn't deserialize {} data for {}.{} in {partition_name}: {e}",
											$round,
							...
							hitman_commons::game::GameVersion::H3 => {
								...
								hitman_bin1::serialize(&hitman_bin1::deserialize::<$h3_ty>(&$data).unwrap_or_else(
									|e| {
										panic!(
											"Couldn't deserialize {} data for {}.{} in {partition_name}: {e}",
											$round,
